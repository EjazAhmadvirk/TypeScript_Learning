...
// for output link this file with HTML file
// and run in browser console to see the output
// for link use <script type="module" src="DataTypes.ts"></script>
// This code demonstrates basic TypeScript data types and their usage
